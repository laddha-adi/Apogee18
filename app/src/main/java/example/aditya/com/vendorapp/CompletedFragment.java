...
public class CompletedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // .setReverseLayout(true);
        ...
        adapter = new CompleteOrdersAdapter(getContext(),orderArrayList);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot orders : dataSnapshot.getChildren()) {
                    try{
                        ...
                        if((boolean)orders.child("order_complete").getValue()==true||(boolean) orders.child("cancelled").getValue()==true)

                        {
                            ...
                            for(DataSnapshot order_item : orders.child("sales").getChildren()) {
                                ...
                                long price = (Long) order_item.child("product").child("price").getValue();
